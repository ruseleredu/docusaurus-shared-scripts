...
- [Aula de Laboratório — Bits, Bytes e Operadores no ESP32](/lab/extras/bits-bytes-operadores)

---

## Estruturas de Controle no ESP32

- [Aula de Laboratório — Estruturas de Controle no ESP32](/lab/extras/estruturas-de-controle)
