...
<FileTree root="lab02-grupo-x (git repo)" files={["wokwi.toml add"]} />
...
- [Aula de Laboratório — Tipos de Dados e Constantes no ESP32](/mic-docs/lab/tipos-dados-constantes)

---

## Bits, Bytes e Operadores no ESP32

- [Aula de Laboratório — Bits, Bytes e Operadores no ESP32](/mic-docs/lab/bits-bytes-operadores)

---

## Estruturas de Controle no ESP32

- [Aula de Laboratório — Estruturas de Controle no ESP32](/mic-docs/labs/estruturas-de-controle)
